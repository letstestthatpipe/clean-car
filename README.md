# Demo API for clean car

# clean-car-api OpenAPI Specification
[![Build Status](https://travis-ci.com/bvasegh/clean-car.svg?branch=master)](https://travis-ci.com/bvasegh/clean-car)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://bvasegh.github.io/clean-car/)
- [SwaggerUI](https://bvasegh.github.io/clean-car/swagger-ui/)
- OpenAPI Raw Files: [JSON](https://bvasegh.github.io/clean-car/openapi.json) [YAML](https://bvasegh.github.io/clean-car/openapi.yaml)
